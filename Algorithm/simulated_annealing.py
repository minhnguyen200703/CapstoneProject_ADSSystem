...
def simulated_annealing(trucks, taskjobs, graph, containers, initial_temperature=10000, cooling_rate=0.003, stopping_temperature=1):
    ...
    current_distance = calculate_total_distance(current_plan, trucks, taskjobs, graph, containers)
    ...
    while temperature > stopping_temperature:
        ...
        neighbor_distance = calculate_total_distance(neighbor_plan, trucks, taskjobs, graph, containers)
